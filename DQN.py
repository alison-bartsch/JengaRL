...
SAVE_STR = 'fullgame_special_R_6000layersize'     # 'disc_row_R'  # 'disc_std_R'     # 'disc_high_R'
PATH = './Models/model_fullgame_best_6000layersize.ckpt'
...
for k in range(75):
    ...
    blocks_removed.append(n_removed)
